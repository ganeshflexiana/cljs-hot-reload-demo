...
var i_14526 = (self__.level + (1));
while(true){
if((i_14526 <= (new_level + (1)))){
(update[i_14526] = self__.header);

var G__14528 = (i_14526 + (1));
i_14526 = G__14528;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14531 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14531[i]));
} else {
x__$2.forward.push((((i < links_14531.length))?(links_14531[i]):null));
}

if((i < links_14531.length)){
(links_14531[i] = x__$2);
} else {
links_14531.push(x__$2);
}
...
var i_14539 = (0);
while(true){
if((i_14539 <= self__.level)){
var links_14540 = (update[i_14539]).forward;
if((x__$1 === (((i_14539 < links_14540.length))?(links_14540[i_14539]):null))){
(links_14540[i_14539] = (x__$1.forward[i_14539]));

var G__14544 = (i_14539 + (1));
i_14539 = G__14544;
continue;
} else {
var G__14545 = (i_14539 + (1));
i_14539 = G__14545;
continue;
}
} else {
...
var G__14550 = nx;
var G__14551 = (level__$1 - (1));
x = G__14550;
level__$1 = G__14551;
continue;
} else {
var G__14553 = x;
var G__14554 = (level__$1 - (1));
x = G__14553;
level__$1 = G__14554;
continue;
}
