...
var G__20673 = o;
reagent.impl.template.goog$module$goog$object.set(G__20673,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__20920__delegate = function (args){
...
while (G__20921__i < G__20921__a.length) {G__20921__a[G__20921__i] = arguments[G__20921__i + 0]; ++G__20921__i;}
  args = new cljs.core.IndexedSeq(G__20921__a,0,null);
} 
return G__20920__delegate.call(this,args);};
G__20920.cljs$lang$maxFixedArity = 0;
G__20920.cljs$lang$applyTo = (function (arglist__20922){
var args = cljs.core.seq(arglist__20922);
return G__20920__delegate(args);
});
...
var G__20687 = o;
reagent.impl.template.goog$module$goog$object.set(G__20687,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__20923__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__20924__i < G__20924__a.length) {G__20924__a[G__20924__i] = arguments[G__20924__i + 0]; ++G__20924__i;}
  args = new cljs.core.IndexedSeq(G__20924__a,0,null);
} 
return G__20923__delegate.call(this,args);};
G__20923.cljs$lang$maxFixedArity = 0;
G__20923.cljs$lang$applyTo = (function (arglist__20925){
var args = cljs.core.seq(arglist__20925);
return G__20923__delegate(args);
});
...
var G__20706 = props;
var G__20706__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20706,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20706);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20706__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__20711 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20711,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__20711;
}
})(),id_class);
...
var G__20719 = (cljs.core.count(argv) - first_child);
switch (G__20719) {
case (0):
...
var vec__20745 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20745,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20745,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20745,(2),null);
...
var temp__5827__auto___20977 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___20977 == null)){
} else {
var key_20978 = temp__5827__auto___20977;
(jsprops.key = key_20978);
}
...
var temp__5827__auto___20980 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___20980 == null)){
} else {
var key_20981 = temp__5827__auto___20980;
(jsprops.key = key_20981);
}
...
var temp__5827__auto___20983 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___20983 == null)){
} else {
var key_20984 = temp__5827__auto___20983;
(jsprops.key = key_20984);
}
...
var temp__5827__auto___20985 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___20985 == null)){
} else {
var key_20986 = temp__5827__auto___20985;
(jsprops.key = key_20986);
}
...
var temp__5827__auto___20987 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___20987 == null)){
} else {
var key_20988 = temp__5827__auto___20987;
(jsprops.key = key_20988);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20816_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__20816_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__20828 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20828,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20828,(1),null);
...
break;
default:
var G__20993 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__20994 = compiler;
v = G__20993;
compiler = G__20994;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template20878 = (function (opts,id,fn_to_element,parse_fn,meta20879){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template20878.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20880,meta20879__$1){
var self__ = this;
var _20880__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template20878(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta20879__$1));
}));

(reagent.impl.template.t_reagent$impl$template20878.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20880){
var self__ = this;
var _20880__$1 = this;
return self__.meta20879;
}));

(reagent.impl.template.t_reagent$impl$template20878.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template20878.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template20878.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template20878.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template20878.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template20878.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta20879","meta20879",-2124629885,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template20878.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template20878.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template20878");

(reagent.impl.template.t_reagent$impl$template20878.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template20878");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template20878.
 */
reagent.impl.template.__GT_t_reagent$impl$template20878 = (function reagent$impl$template$__GT_t_reagent$impl$template20878(opts,id,fn_to_element,parse_fn,meta20879){
return (new reagent.impl.template.t_reagent$impl$template20878(opts,id,fn_to_element,parse_fn,meta20879));
});
...
return (new reagent.impl.template.t_reagent$impl$template20878(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
